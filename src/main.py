...
oleg_rub_account = BankAccount(user_data={"name": "Oleg", "surname": "Ezhikov"}, currency="RUB")
john_usd_account = BankAccount(user_data={"name": "John", "surname": "Doe"}, currency="USD")
